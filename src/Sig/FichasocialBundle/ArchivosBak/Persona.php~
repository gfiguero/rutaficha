...
class Persona
{
     ...
     * Set rol_domicilio
     *
     * @param string $rolDomicilio
     * @return Persona
     */
    public function setRolDomicilio($rolDomicilio)
    {
        $this->rol_domicilio = $rolDomicilio;
     ...
     * @return string 
     */
    public function getRolDomicilio()
    {
        return $this->rol_domicilio;
    }
}
